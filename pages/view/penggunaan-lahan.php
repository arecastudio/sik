<?php
$id_jenis=1;
if (isset($_GET['id_jenis'])) $id_jenis=$_GET['id_jenis'];
?>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <ul class="nav nav-tabs">
	  <li role="presentation" <?php if($id_jenis==1) echo "class='active'";?> ><a href="?ref=penggunaan-lahan&id_jenis=1">Tanah Sawah</a></li>
	  <li role="presentation" <?php if($id_jenis==2) echo "class='active'";?>><a href="?ref=penggunaan-lahan&id_jenis=2">Tanah Kering</a></li>
	  <li role="presentation" <?php if($id_jenis==3) echo "class='active'";?>><a href="?ref=penggunaan-lahan&id_jenis=3">Tanah Basah</a></li>
	  <li role="presentation" <?php if($id_jenis==4) echo "class='active'";?>><a href="?ref=penggunaan-lahan&id_jenis=4">Tanah Perkebunan</a></li>
	  <li role="presentation" <?php if($id_jenis==5) echo "class='active'";?>><a href="?ref=penggunaan-lahan&id_jenis=5">Tanah Fas. Umum</a></li>
	  <li role="presentation" <?php if($id_jenis==6) echo "class='active'";?>><a href="?ref=penggunaan-lahan&id_jenis=6">Tanah Hutan</a></li>
	</ul>
	<br/>
